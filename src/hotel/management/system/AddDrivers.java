...
public class AddDrivers extends JFrame implements ActionListener{
    ...
    public AddDrivers() {
        ...
        JLabel l5 = new JLabel("Seating Capacity");
        ...
        // Force revalidation and repainting to ensure UI is updated correctly
        ...
        try {
            if (ae.getSource() == b1) {
                try {
                    ...
                    String str = "INSERT INTO driver values( '" + name + "', '" + age + "', '" + gender + "','" + company
