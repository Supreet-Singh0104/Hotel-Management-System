...
public class NewCustomer extends JFrame {
    ...
    JComboBox comboBox;
    JRadioButton r1, r2;
    ButtonGroup genderGroup;  // To group the radio buttons
    Choice c1;
	...
	public NewCustomer() throws SQLException {
        ...
        try{
           ...
           //ResultSet rs = c.s.executeQuery("SELECT * FROM room WHERE LOWER(availability) = 'available'");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
                ...
                try{
                    ...
                    String q1 = "insert into customer(document, number, name, gender, country, room, checkintime, deposit) values('"
